...
* <code>0x7F - 0xFF</code>. The SCSU provides transparency for the characters 
* (bytes) between <code>U+0000 - U+00FF</code>.  The SCSU approximates the 
...
*
* <P>The static methods on <code>UnicodeCompressor</code> may be used in a
...
* <code>UnicodeCompressor</code> offers more powerful APIs allowing
...
public final class UnicodeCompressor implements SCSU
{
    ...
    * @return true if <code>c</code> will fit in <code>whichWindow</code>, 
    * false otherwise.
    */
    ...
    * @param c The character to test.
    * @return true if the <code>c</code> is compressible, false otherwise.
    */
     ...
     * @param c The character in question
     * @return The dynamic window containing <code>c</code>, or 
     ...
     * @param c The character in question
     * @return The static window containing <code>c</code>, or 
     * INVALIDWINDOW if not defined.
     */
