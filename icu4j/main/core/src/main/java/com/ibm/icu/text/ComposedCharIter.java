 ...
 * <p>
 * <code>ComposedCharIter</code> is an iterator class that returns all
 ...
 * To do so, use a <code>ComposedCharIter</code> to iterate through all of the
 ...
 * <p>
 * Note that <code>ComposedCharIter</code> iterates over a <em>static</em> table
 ...
 * <p>
 * When constructing a <code>ComposedCharIter</code> there is one
 ...
 * </ul>
 * <p>
 * <code>ComposedCharIter</code> is currently based on version 2.1.8 of the
...
public final class ComposedCharIter {
    ...
    /**
     * Construct a new <code>ComposedCharIter</code>.  The iterator will return
    ...
    /**
     * Constructs a non-default <code>ComposedCharIter</code> with optional behavior.
     * <p>
     * @param compat    <code>false</code> for canonical decompositions only;
     *                  <code>true</code> for both canonical and compatibility
     *                  decompositions.
     *
     ...
     * Repeated calls to <code>next</code> return all of the precomposed characters defined
     * by Unicode, in ascending order.  After all precomposed characters have
     * been returned, {@link #hasNext} will return <code>false</code> and further calls
     * to <code>next</code> will return {@link #DONE}.
     * @deprecated ICU 2.2
     */
    @Deprecated
    public char next() {
