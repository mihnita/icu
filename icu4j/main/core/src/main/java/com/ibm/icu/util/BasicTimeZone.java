...
public abstract class BasicTimeZone extends TimeZone {
     ...
     * <p>Example code:{@snippet file='com/ibm/icu/samples/util/timezone/BasicTimeZoneExample.java' region=getNextTransitionExample}
     *
     ...
     * <p>Example code:{@snippet file='com/ibm/icu/samples/util/timezone/BasicTimeZoneExample.java' region=getPreviousTransitionExample}
     *
     * @param base      The base time.
     * @param inclusive Whether the base time is inclusive or not.
     *
     ...
     * time range.
     * <p>Example code:{@snippet file='com/ibm/icu/samples/util/timezone/BasicTimeZoneExample.java' region=hasEquivalentTransitionsExample}
     *
     ...
     * <p>Example code:{@snippet file='com/ibm/icu/samples/util/timezone/BasicTimeZoneExample.java' region=getTimeZoneRulesExample}
     *
