...
/**
 * Extensions and enhancements to java.text to support unicode transforms,
 * {@code UnicodeSet}, surrogate char utilities, UCA collation, normalization,
 * break iteration (rule and dictionary based), enhanced number format,
