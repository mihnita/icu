...
public final class Normalizer implements Cloneable {
    ...
    /**
     * Clones this <code>Normalizer</code> object.  All properties of this
     * object are duplicated in the new object, including the cloning of any
     * {@link CharacterIterator} that was passed in to the constructor
     * or to {@link #setText(CharacterIterator) setText}.
     * However, the text storage underlying
     * the <code>CharacterIterator</code> is not duplicated unless the
     * iterator's <code>clone</code> method does so.
     *
     * @deprecated ICU 56 Use {@link Normalizer2} instead.
     */
    @Deprecated
    ...
    /**
     * Normalizes a <code>String</code> using the given normalization operation.
     * <p>
     * The <code>options</code> parameter specifies which optional
     ...
     * by <code>next</code> and <code>previous</code> and the indices passed to and
     * returned from <code>setIndex</code> and {@link #getIndex}.
     * <p>
     * @param index the desired index in the input text.
     *
     ...
     * index of the <code>CharacterIterator</code> or the start (i.e. 0) of the
     * <code>String</code> over which this <code>Normalizer</code> is iterating
     ...
     * of the <code>CharacterIterator</code> or the length of the <code>String</code>
     ...
     * the <code>Normalizer's</code> position to the beginning of the text.
     * @return The codepoint as an int
     * @deprecated ICU 56
     */
    @Deprecated
     ...
     * the <code>Normalizer's</code> position to be just before the
     ...
     * correspondence between characters returned by <code>next</code> and
     * <code>previous</code> and the indices passed to and returned from
     * <code>setIndex</code> and {@link #getIndex}.
     ...
     *                  turn the option on and <code>false</code> to turn it off.
     *
     * @see #getOption
     * @deprecated ICU 56
     */
