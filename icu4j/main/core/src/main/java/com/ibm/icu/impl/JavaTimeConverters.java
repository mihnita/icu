...
public class JavaTimeConverters {
     ...
     * instant as provided by the specified {@link Clock}. The resulting
     ...
     */
    public static Calendar temporalToCalendar(ChronoLocalDateTime<?> dateTime) {
        long epochMillis = dateTime.toEpochSecond(UTC) * 1_000 + dateTime.get(MILLI_OF_SECOND);
        return millisToCalendar(epochMillis);
    }
