...
/**
 * <code>SearchIterator</code> is an abstract base class that provides 
 * methods to search for a pattern within a text string. Instances of
 * <code>SearchIterator</code> maintain a current position and scan over the 
 * target text, returning the indices the pattern is matched and the length 
 * of each match.
 * <p>
 * <code>SearchIterator</code> defines a protocol for text searching. 
 * Subclasses provide concrete implementations of various search algorithms. 
 * For example, <code>StringSearch</code> implements language-sensitive pattern 
 ...
 * other text iteration classes such as <code>BreakIterator</code>. Using 
 * this class, it is easy to scan through text looking for all occurrences of 
 * a given pattern. The following example uses a <code>StringSearch</code> 
 * object to find all instances of "fox" in the target string. Any other 
 * subclass of <code>SearchIterator</code> can be used in an identical 
 * manner.
 * <pre><code>
...
public abstract class SearchIterator 
{
     ...
     *                for. If this parameter is <code>null</code>, no break
    ...
    */
     ...
     * If the {@link BreakIterator} has not been set, <code>null</code> will be returned.
    ...
    */
    ...
    /**
     * Returns the first index equal or greater than <code>position</code> at which the 
     ...
     *         <code>position</code>, or {@link #DONE} if there are no matches.
    ...
    /**
     * Returns the first index less than <code>position</code> at which the string 
     ...
     *         <code>position</code>, or {@link #DONE} if there are 
     *         no matches.
