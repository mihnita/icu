...
def tools(): # unless="apireport.jar.exists"
...
def main():
  ...
  parser.add_argument('--tools', help='Compile the release tools', action='store_true')
  parser.add_argument('--olddir', help='Directory that contains xml docs of old version')
  parser.add_argument('--newdir', help='Directory that contains xml docs of new version')
  parser.add_argument('--apireport', help='Generate the apireport in HTML format', action='store_true')
  parser.add_argument('--apireport_md', help='Generate the apireport in Markdown format', action='store_true')
  parser.add_argument('--apireport_xml', help='Generate the apireport in XML format', action='store_true')
